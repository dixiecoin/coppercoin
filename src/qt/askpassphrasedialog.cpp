            ...
            if(newpass1 == newpass2)
            {
                if(model->setWalletEncrypted(true, newpass1))
                {
                    QMessageBox::warning(this, tr("Wallet encrypted"),
                                         tr("BarCoin will close now to finish the encryption process. Remember that encrypting your wallet cannot fully protect your foocoin from being stolen by malware infecting your computer."));
                    QApplication::quit();
                }
                else
                {
